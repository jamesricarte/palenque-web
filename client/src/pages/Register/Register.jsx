        ...
        <div className="flex flex-col lg:flex-row w-full h-full">
          ...
          <div className="lg:w-1/3 w-full flex items-center justify-center p-8 bg-orange-500">
            <div className="bg-white p-6 rounded shadow-md w-full max-w-sm">
              ...
              <p className="text-m text-orange-500 mb-4">Be part of something fresh.</p>
              ...
              <p className="text-m">Confirm Password</p>
              <div className="relative mb-3">
              <input
              ...
              <Link to="/login/">
              <button className="w-full bg-orange-500 text-white py-2 rounded mb-3 font-semibold">Register</button>
              </Link>
              <p className="text-center text-sm text-gray-500 mb-2">Or register with</p>
